...
class NewRevisionStopView(NewRevisionAccessMixin, ConfirmView):
    ...
    warning_text = _("Are you sure to stop creating a new revision?")
    ...
    def get_page_title(self) -> str:
        return _("Stop Creating a New Revision?")

    def get_form_cancel_text(self) -> str:
        return _("Back")

    def get_form_submit_text(self) -> str:
        return _("Stop Creating Revision")
